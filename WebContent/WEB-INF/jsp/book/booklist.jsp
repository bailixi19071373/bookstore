		...
		<form action="<%=path%>/book/delbooks" id="myform" method="post">
			<div class="result-title">
				<div class="result-list">
					<a href="<%=path%>/book/forwardaddbook"><i class="icon-font"></i>新增图书</a> 
			...
			<div class="result-content">
				...
				<div>
				 ...
				 <option value="20" <c:if test="${15==rowPerPage}">selected</c:if>>20</option>
				 </select>条
				</div>
			 ...
			 <button class="btn btn-primary btn2" id="last" type="button">尾页</button></div> 
			</div>
		</form>
	</div>
	<!--/main-->
