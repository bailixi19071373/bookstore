...
<body>
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">图书管理</a><span class="crumb-step">&gt;</span><span>修改图书</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                         <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="isbn" placeholder="必须是10位数字"
                                    name="isbn" size="50" value="${book.isbn}" type="text" required pattern="\d{10}"
                                    readonly="readonly"
                                    >
                                    <span id="isbninfo" class="erroinfo"></span>
                                </td> 
                            </tr>
                        <tr>
                                <th><i class="require-red">*</i>图书名称：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="${book.title }" type="text" required="required">
                                </td>
                            </tr>
                        <tr>
                         <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="pubdate" name="pubdate" size="50" value="${book.pubdate }" type="date" required="required">
                                </td>
                            </tr>
                        <tr>
                            <th width="120"><i class="require-red">*</i>出版社：</th>
                            <td>
                            <select name="pubid" id="publisherSel" class="required" required="required">
                           ...
                           <tr>
                            ...
                            <tr>
                                <th>成本：</th>
                                <td><input class="common-text" name="cost" 
                                size="50" value="${book.cost }" type="text"></td>
                            </tr>
                              <tr>
                                <th>售价：</th>
                                <td><input class="common-text" name="retail" size="50" value="${book.retail }" type="text"></td>
                            </tr>
                             <tr>
                            <th width="120">类别：</th>
                            <td>
