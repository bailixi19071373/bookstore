                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input required="required"  placeholder="请填写旧密码" class="common-text required" id="old" name="old" size="50" value="" type="text">
                           ...
                           <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span id="new2erroinfo" class="errorinfo"></span>
                                </td>
